...
echo '<div class="uich-container-main">';
	...
	echo '<div class="uich-welcome-section container">';
		echo '<div class="uich-left-text">';
			...
			echo '<div class="uich-btn-group">';
				echo '<a target="_blank" rel="noopener noreferrer" href="https://www.figma.com/community/plugin/1265873702834050352" class="uich-yellow-btn">'.esc_html__('Install Figma Plugin', 'uichemy').'</a>';
				echo '<a class="uich-quick-link" href="https://uichemy.com/" target="_blank" rel="noopener noreferrer">Learn More</a>';
			echo '</div>';
		echo '</div>';
	...
	echo '<div class="uich-quick-link-cards container">';
		...
		echo '<div class="uich-card-main">';
			echo '<h4 class="uich-heading">'.esc_html__('Need Help?', 'uichemy').'</h4>';
			echo '<a target="_blank" rel="noopener noreferrer" href="https://store.posimyth.com/helpdesk/" class="uich-border-btn">Raise Ticket</a>';
		echo '</div>';
	...
	echo '<div class="uich-welcome-section uich-templates-section container">';
		echo '<div class="uich-left-text">';
			echo '<h1 class="uich-heading">'.esc_html__('UiChemy Templates', 'uichemy').'</h1>';
			echo '<p class="uich-paragraph">'.esc_html__('We`re offering a Lifetime Deal for a limited time only. Afterward, we will switch to only offering Yearly Plans.', 'uichemy').' </p>';
			echo '<div class="uich-btn-group">';
				echo '<a target="_blank" rel="noopener noreferrer" href="https://www.figma.com/community/file/1329383275066935195/uichemy-educational-community-file" class="uich-yellow-btn">'.esc_html__('Template Library', 'uichemy').'</a>';
			echo '</div>';
		echo '</div>';
		echo '<div class="uich-right-img">';
