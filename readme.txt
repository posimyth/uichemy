...
_NB: You can also manually download JSON file and import Templates_
...
- [Supports 30+ Elementor Widgets](https://elementor.com/widgets/)
...
Yes, we've released our Bricks Builder integration - [Figma Plugin for Bricks Builder](https://www.figma.com/community/plugin/1344313361212431142) 
...
All UiChemy users receive support directly from our helpdesk & livechat. You can reach with any of [the following methods](https://store.posimyth.com/get-support-uichemy/) to get support with UiChemy.
...
== Screenshots ==
1. UiChemy Figma to WordPress (Gutenberg, Elementor & Bricks)
2. Figma to Elementor Convertor
3. Figma to Bricks Builder Convertor
4. Figma to WordPress Gutenberg Convertor
5. UiChemy WordPress Plugin Connector
6. Publish Figma Design Directly to WordPress website

== Changelog ==
= 3.1.2 = 30 June 2025
- Fixed a bug with elementor's global settings & latest elementor version.
